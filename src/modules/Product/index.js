...
const Product = () => {
  ...
  if (!Object.keys(product).length > 0)
    return <div className="h-[55vh] flex justify-center items-center text-4xl">Loading....</div>;
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className=" flex">
                <button
                  className="flex ml-auto text-white mr-2 bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded"
